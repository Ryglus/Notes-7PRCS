...
function LoginPage() {
  ...
  return (
    <div className="flex mx-auto justify-center items-center w-full md:w-1/2 xl:w-1/3">
      <div className="container login-container py-5 px-0 my-20 rounded-lg bg-zinc-900">
        <div className="toggle-container flex justify-center" id="toggleContainer">
          <span className="bg-gradient-to-br from-blue-300 to-purple-700 absolute right-1/2 border w-1/2 h-full rounded-full border-0 z-0" id="toggle"></span>
          <button
